...
begin
  ...
  //kt original --> CheckBoilerplate4Fields(frmTemplateView.reMain.Lines, frmTemplateView.Caption, TRUE);
  DBControlData := TDBControlData.Create;  //kt added 5/16
  CheckBoilerplate4Fields(frmTemplateView.reMain.Lines, frmTemplateView.Caption, [tPreview], DBControlData);
