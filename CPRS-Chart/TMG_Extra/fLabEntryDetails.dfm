object frmLabEntryDetails: TfrmLabEntryDetails
  Left = 0
  Top = 0
  Caption = 'Lab Entry Details'
  ClientHeight = 142
  ClientWidth = 499
  Color = clBtnFace
  ...
  object lblSpecimen: TLabel
    ...
    Alignment = taRightJustify
    AutoSize = False
    Caption = 'Default Specimen'
    Visible = False
    WordWrap = True
  end
  object lblDTTaken: TLabel
    Left = -6
    Top = 8
    Width = 64
    Height = 24
  ...
  object Label1: TLabel
    ...
    Width = 256
    Height = 13
    Caption = '(For multiple dates, change default date on lab table)'
  end
  object cboProvider: TORComboBox
    ...
    TabOrder = 1
    TabStop = True
    OnChange = dtpControlExit
    OnExit = dtpControlExit
  ...
  object dtpDTTaken: TDateTimePicker
    ...
    Width = 119
    Height = 21
    Date = 41520.853454409720000000
    Time = 41520.853454409720000000
    TabOrder = 0
    OnExit = dtpControlExit
    OnKeyPress = dtpDTPickerKeyPress
  end
end
