...
function UpdatePCE(PCEData: TPCEData; SaveOnExit: boolean = TRUE; InitialPageIndex : byte = 0): boolean;  //kt 5/16/16
...
///////////////////////////////////////////////////////////////////////////////}
//kt original --> function UpdatePCE(PCEData: TPCEData; SaveOnExit: boolean = TRUE): boolean;
function UpdatePCE(PCEData: TPCEData; SaveOnExit: boolean = TRUE; InitialPageIndex : byte = 0): boolean;
var
//  FontHeight,
//  FontWidth: Integer;
  AUser: string;
...
begin
  ...
  try
    ...
    begin
      ...
      SynchPCEData;
      //kt original --> TabControl.Tabindex := 0;
      TabControl.Tabindex := InitialPageIndex;   //kt 5/16
...
begin
  ...
  with uEncPCEData do begin                             // load any existing data from PCEData
    if FormListContains(CT_VisitNm) then
