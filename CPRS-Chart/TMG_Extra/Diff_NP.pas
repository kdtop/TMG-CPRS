...
//kt note: Downloaded frm here: http://www.angusj.com/delphi/textdiff.html on 8/18/17
//kt initials is Kevin Toppenberg
...
{$ENDIF}
  ...
  //kt original --> TDiff = class(TComponent)
  TDiff = class(TObject)  //modified by //kt
  private
    fCompareList: TList;
  ...
  public
    //kt original --> constructor Create(aOwner: TComponent); override;
    constructor Create(aOwner: TObject); //kt
...
//kt original --> constructor TDiff.Create(aOwner: TComponent);
constructor TDiff.Create(aOwner: TObject); //kt
begin
  //kt original --> inherited;
  inherited create;
...
begin
  ...
  try
    ...
    Len1Minus1 := len1 -1;
    fCompareList.Capacity := len1 + len2;
    fDiffList.Capacity := 4096;  //kt mod.  Original --> 1024;
    fCompareInts := false;
