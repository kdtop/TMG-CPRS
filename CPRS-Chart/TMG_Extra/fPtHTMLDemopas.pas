...
begin
  ...
  frmPtDemo := TfrmPtHTMLDemo.Create(Application);
  try
...
begin
  ...
  if DoesHTMLFacesheetExist then begin
    HTMLDemoViewer := THtmlObj.Create(fPtDemo,Application);
    HTMLDemoViewer.Anchors := [akLeft,akTop,akRight,akBottom];
    HTMLDemoViewer.Left := 0;
    HTMLDemoViewer.Top := 0;
    HTMLDemoViewer.Width := memPtDemo.Width;
    HTMLDemoViewer.Height := memPtDemo.Height;
    HTMLDemoViewer.BringToFront;
    LoadHTMLDemographics(rtDemographics);
    HTMLDemoViewer.HTMLText := rtDemographics.Text;
    ...
    LoadDemographics(rtDemographics);
    memPtDemo.Lines.Clear;
    memPtDemo.text :=rtDemographics.text;
