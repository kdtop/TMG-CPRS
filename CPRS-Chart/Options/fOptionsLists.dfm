inherited frmOptionsLists: TfrmOptionsLists
  ...
  object btnAddCurPt: TButton [19]
    Left = 166
    Top = 143
    Width = 75
    Height = 22
    HelpContext = 9082
    Caption = 'Add Current Pt'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
    ...
    ParentFont = False
    TabOrder = 18
    OnClick = btnAddCurPtClick
  end
  object btnExportList: TButton [20]
    Left = 71
    Top = 96
    Width = 89
    Height = 16
  ...
  object btnPerExport: TButton [21]
    Left = 322
    Top = 96
    Width = 75
    Height = 16
  ...
  inherited amgrMain: TVA508AccessibilityManager
    Data = (
      ...
      (
        ...
        'Status = stsDefault')
      (
        'Component = btnAddCurPt'
        'Status = stsDefault')
      (
        'Component = btnExportList'
        'Status = stsDefault')
      (
        'Component = btnPerExport'
        'Status = stsDefault'))
  end
