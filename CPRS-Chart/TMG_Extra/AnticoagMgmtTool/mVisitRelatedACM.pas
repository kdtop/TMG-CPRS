unit mVisitRelatedACM;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls, ExtCtrls, mPCE_ACM;

type
  TfraVisitRelatedACM = class(TFrame)
...
procedure TfraVisitRelatedACM.chkClick(Sender: TObject);
...
constructor TfraVisitRelatedACM.Create(AOwner: TComponent);
begin
...
function TfraVisitRelatedACM.GetCheckState(CheckYes, CheckNo: TCheckBox): Integer;
begin
  Result := SCC_NA;
...
procedure TfraVisitRelatedACM.GetRelated(PCEData: TPCEData);
begin
...
procedure TfraVisitRelatedACM.InitAllow(SCCond: TSCConditions);
begin
  FSCCond := SCCond;
  with FSCCond do
  begin
...
procedure TfraVisitRelatedACM.InitRelated(PCEData: TPCEData);
begin
...
procedure TfraVisitRelatedACM.SetCheckEnable(CheckYes, CheckNo: TCheckBox;
  Allow: Boolean);
begin
...
procedure TfraVisitRelatedACM.SetCheckState(CheckYes, CheckNo: TCheckBox; CheckState: Integer);
begin
