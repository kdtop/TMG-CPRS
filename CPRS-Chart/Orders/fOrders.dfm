inherited frmOrders: TfrmOrders
  ...
  inherited pnlLeft: TPanel
    ...
    object btnCompletedLoad: TSpeedButton
      Left = 94
      Top = 6
      Width = 17
      Height = 13
      Hint = 'Show Completed Orders'
      Margins.Top = 1
      Margins.Bottom = 2
      Caption = 'C'
      Flat = True
  ...
  object mnuOrders: TMainMenu
    ...
    object mnuView: TMenuItem
      ...
      object mnuViewCompleted: TMenuItem
        Caption = '&Completed Orders'
        OnClick = mnuViewCompletedClick
      end
      object Z2: TMenuItem
        Caption = '-'
      end
  ...
  object popOrder: TPopupMenu
    ...
    object popCopyOrderText: TMenuItem
      Caption = 'Copy Order Text'
      OnClick = popCopyOrderTextClick
    end
