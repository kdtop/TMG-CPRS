  ...
  object pnlBottom: TPanel [0]
    ...
    object pnlTMGCredits: TPanel
      ...
      object Memo1: TMemo
        ...
        Font.Style = []
        Lines.Strings = (
          'OPEN SOURCE CONTRIBUTORS to TMG CPRS: '
          
            '----------------------------------------------------------------' +
            '----'
          '  Family Physicians of Greeneville, PC  '
          '  Astronaut, LLC'
          '  Sequence Managers Software, LLC'
          '  Ramathibodi Hospital (Thailand)'
          '  Hakeem National E-Health Hospital (Jordan)'
          '  Oroville Hospital (Oroville, California)'
          '  MSP Multispecialty Clinic (Arizona)'
