  ...
  object pnlMain: TPanel [1]
    ...
    object pagOptions: TPageControl
      ...
      object tsImages: TTabSheet
        ...
        object lblSelEditFor: TLabel
          Left = 17
          Top = 135
          Width = 83
          Height = 13
          Caption = 'Select Editor For:'
        end
        object btnDelType: TSpeedButton
          Left = 384
          Top = 151
          Width = 23
          Height = 20
          ...
          OnClick = btnDelTypeClick
        end
        object lblStockImgFolder: TLabel
          Left = 17
          Top = 178
          Width = 97
          Height = 13
          Caption = 'Stock Images Folder'
        end
        object lblAddSigPic: TLabel
          Left = 17
          Top = 232
          Width = 173
          Height = 13
          Caption = 'Update / Add Signature Image  for: '
        end
        object cbEnableImages: TCheckBox
          Left = 16
          Top = 3
          Width = 137
          Height = 17
        ...
        object btnBrowseStockImages: TBitBtn
          Left = 177
          Top = 198
          Width = 41
          Height = 20
  ...
  inherited amgrMain: TVA508AccessibilityManager
    Data = (
      ...
      (
        ...
        'Status = stsDefault')
      (
        'Component = cbEnableImages'
        'Status = stsDefault')
      (
        'Component = cboTransMethod'
        'Status = stsDefault')
      (
        'Component = editDropboxLocation'
        'Status = stsDefault')
      (
        'Component = btnBrowseDropBox'
        'Status = stsDefault')
      (
        'Component = cbEnableScanning'
        'Status = stsDefault')
      (
        'Component = editScannedLocation'
        'Status = stsDefault')
      (
        'Component = btnBrowseScannedImages'
        'Status = stsDefault')
      (
        'Component = edtPolFreq'
        'Status = stsDefault')
      (
        'Component = cboImageType'
        'Status = stsDefault')
      (
        'Component = edtEditorName'
        'Status = stsDefault')
      (
        'Component = btnPickEditor'
        'Status = stsDefault')
      (
        'Component = editStockLocation'
        'Status = stsDefault')
      (
        'Component = btnBrowseStockImages'
        'Status = stsDefault')
      (
        'Component = btnAddSigImage'
        'Status = stsDefault')
      (
