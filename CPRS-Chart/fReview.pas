...
//kt 9/11 made changes to *FORM* of this unit, added TMGAutoPrintCKBox: TCheckBox;
...
type
  TfrmReview = class(TfrmBase508Form)
    ...
    pnlTop: TPanel;
    TMGAutoPrintCKBox: TCheckBox;   //kt 9/11
...
var  HasDocToSign, ShowAutoPrint : boolean; //kt 9/11
     i : integer;  //kt 9/11
begin
  //kt 9/11 --- Begin Mod ---
  ShowAutoPrint := false;   //Only show when button caption = 'Sign'
  HasDocToSign := false;
  ...
  if(not pnlSignature.Visible) then begin
    ...
    if Length(txtESCode.Text) > 0 then begin
      cmdOK.Caption := 'Sign';
      if HasDocToSign then ShowAutoPrint := true; //kt 9/11
    end else begin
      //kt 9/11 if FCouldSign then cmdOK.Caption := 'Don''t Sign' else cmdOK.Caption := 'OK';
      if FCouldSign then cmdOK.Caption := 'Don''t Sign';  //kt 9/11
    end;
  end;
  TMGAutoPrintCKBox.Visible := ShowAutoPrint;  //kt 9/11
end;
    ...
    if ChangeItem <> nil then with ChangeItem do
      ...
      CH_DOC: if Checked[i]
                then begin                                                                //kt 9/11
                  ...
                  if TMGAutoPrintCKBox.Visible and TMGAutoPrintCKBox.Checked then begin   //kt 9/11
                    PrintNote(StrToInt(ChangeItem.ID), ChangeItem.Text);                  //kt 9/11
                  end;                                                                    //kt 9/11
                end                                                                       //kt 9/11
                {--- //kt 9/11 end modificaton --}
