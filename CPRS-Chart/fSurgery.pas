...
begin
  ...
  //kt  NOTE: this form has not been reworked to support HTML or other TMG features...
  //kt Needs to follow pattern of fNotes, fDCSumm
...
function TfrmSurgery.ActiveEditIEN : Int64;
