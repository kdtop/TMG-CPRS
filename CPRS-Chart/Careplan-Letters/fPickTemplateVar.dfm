inherited frmPickTemplateVar: TfrmPickTemplateVar
  Left = 0
  Top = 0
  Caption = 'Pick Template Variable'
  ClientHeight = 424
  ClientWidth = 558
  Font.Name = 'Tahoma'
  OnShow = FormShow
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object reTemplateCopy: TRichEdit [0]
    Left = 0
    Top = 41
    Width = 558
    Height = 348
  ...
  object pnlTop: TPanel [1]
    ...
    Align = alTop
    TabOrder = 1
    object lblPickOne: TLabel
      Left = 8
      Top = 12
      Width = 222
      Height = 16
      Caption = 'Click on Variable Name To Select It'
      Color = clBtnFace
