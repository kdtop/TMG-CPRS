object frmCustomINRGoal: TfrmCustomINRGoal
  Left = 0
  Top = 0
  BorderStyle = bsToolWindow
  Caption = 'Set Other Goal Range'
  ClientHeight = 105
  ClientWidth = 169
  Color = clBtnFace
  ...
  object edtMin: TEdit
    ...
    Width = 89
    Height = 21
    Hint = 'Enter minimum INR goal value'
    TabOrder = 0
  ...
  object edtMax: TEdit
    ...
    Width = 89
    Height = 21
    Hint = 'Enter maximum INR goal value'
    TabOrder = 1
    OnChange = edtMinChange
  end
