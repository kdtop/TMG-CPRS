...
begin
  ...
  //kt if uTIULocation <> 0 then uTIULocationName := ExternalName(uTIULocation, FN_HOSPITAL_LOCATION);
  if (uTIULocation = 0) and (EncounterLastLocation <> 0) and (EncounterLastLocationValid <>'') then uTIULocation := EncounterLastLocation; //kt 9/11
...
begin
  inherited;
  EncounterLastLocation := 0; //kt 9/11
