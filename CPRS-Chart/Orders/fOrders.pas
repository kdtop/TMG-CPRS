...
procedure TfrmOrders.btnActiveLoadClick(Sender: TObject);
begin
  inherited;
  SetOrderView(STS_ACTIVE, DGroupAll, 'Active Orders (includes Pending & Recent Activity) - ALL SERVICES', False);
end;

procedure TfrmOrders.btnCompletedLoadClick(Sender: TObject);
begin
  inherited;
  SetOrderView(STS_COMPLETE, DGroupAll, 'Completed/Expired Orders - ALL SERVICES', False);
end;
...
procedure TfrmOrders.mnuViewCompletedClick(Sender: TObject);
begin
  inherited;
  SetOrderView(STS_COMPLETE, DGroupAll, 'Completed/Expired Orders - ALL SERVICES', False);
end;
